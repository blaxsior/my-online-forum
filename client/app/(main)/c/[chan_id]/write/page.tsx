...
export default function WritePage({ params }: WritePageProps) {
  ...
  function onQuillDataChange(v: string, _1: any, _2: any, editor: UnprivilegedEditor) {
    ...
    <div className="m-4" >
      ...
      <form className='space-y-4 flex flex-col'
        ...
        <div className="flex space-x-1">
          <label htmlFor="title"
            className="px-2 py-[1px] border-[3px] border-gray-400bg-gray-200 text-lg rounded-md">제목</label>
          <input
            {...form.register('title')}
            type='text'
        ...
        {/* button 영역 */}
        <Button type='submit' className='w-fit float-right'>작성</Button>
      </form>
    </div>
  );
};
